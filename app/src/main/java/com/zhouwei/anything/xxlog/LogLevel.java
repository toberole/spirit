...
/**
 * AppLog level indicate how important the log is.
 * <p>
 ...
 * <br>And there are two special log levels which are usually used for AppLog#init:
...
public class LogLevel {
  ...
  /**
   * AppLog level for XLog.v.
   */
  public static final int VERBOSE = 2;

  /**
   * AppLog level for XLog.d.
   */
  public static final int DEBUG = 3;

  /**
   * AppLog level for XLog.i.
   */
  public static final int INFO = 4;

  /**
   * AppLog level for XLog.w.
   */
  public static final int WARN = 5;

  /**
   * AppLog level for XLog.e.
   */
  public static final int ERROR = 6;

  /**
   * AppLog level for XLog#init, printing all logs.
   */
  public static final int ALL = Integer.MIN_VALUE;

  /**
   * AppLog level for XLog#init, printing no log.
   */

...
public class Logger {
  ...
  /**
   * AppLog an object with level {@link LogLevel#VERBOSE}.
   *
  ...
  /**
   * AppLog an array with level {@link LogLevel#VERBOSE}.
   *
  ...
  /**
   * AppLog a message with level {@link LogLevel#VERBOSE}.
   *
  ...
  /**
   * AppLog a message and a throwable with level {@link LogLevel#VERBOSE}.
   *
   * @param msg the message to log
  ...
  /**
   * AppLog an object with level {@link LogLevel#DEBUG}.
   *
   * @param object the object to log
   * @see Builder#addObjectFormatter(Class, ObjectFormatter)
   * @since 1.1.0
  ...
  /**
   * AppLog an array with level {@link LogLevel#DEBUG}.
   *
   * @param array the array to log
   */
  ...
  /**
   * AppLog a message with level {@link LogLevel#DEBUG}.
   *
  ...
  /**
   * AppLog a message and a throwable with level {@link LogLevel#DEBUG}.
   *
   * @param msg the message to log
   * @param tr  the throwable to be log
   */
  ...
  /**
   * AppLog an object with level {@link LogLevel#INFO}.
   *
   * @param object the object to log
   * @see Builder#addObjectFormatter(Class, ObjectFormatter)
   * @since 1.1.0
  ...
  /**
   * AppLog an array with level {@link LogLevel#INFO}.
   *
   * @param array the array to log
   */
  ...
  /**
   * AppLog a message with level {@link LogLevel#INFO}.
   *
   * @param format the format of the message to log, null if just need to concat arguments
   * @param args   the arguments of the message to log
   */
  ...
  /**
   * AppLog a message and a throwable with level {@link LogLevel#INFO}.
   *
   * @param msg the message to log
   * @param tr  the throwable to be log
   */
  ...
  /**
   * AppLog an object with level {@link LogLevel#WARN}.
   *
   * @param object the object to log
   * @see Builder#addObjectFormatter(Class, ObjectFormatter)
   * @since 1.1.0
  ...
  /**
   * AppLog an array with level {@link LogLevel#WARN}.
   *
   * @param array the array to log
   */
  ...
  /**
   * AppLog a message with level {@link LogLevel#WARN}.
   *
   * @param format the format of the message to log, null if just need to concat arguments
   * @param args   the arguments of the message to log
   */
  ...
  /**
   * AppLog a message and a throwable with level {@link LogLevel#WARN}.
   *
   * @param msg the message to log
   * @param tr  the throwable to be log
   */
  ...
  /**
   * AppLog an object with level {@link LogLevel#ERROR}.
   *
   * @param object the object to log
   * @see Builder#addObjectFormatter(Class, ObjectFormatter)
   * @since 1.1.0
  ...
  /**
   * AppLog an array with level {@link LogLevel#ERROR}.
   *
   * @param array the array to log
   */
  ...
  /**
   * AppLog a message with level {@link LogLevel#ERROR}.
   *
   * @param format the format of the message to log, null if just need to concat arguments
   * @param args   the arguments of the message to log
   */
  ...
  /**
   * AppLog a message and a throwable with level {@link LogLevel#ERROR}.
   *
   * @param msg the message to log
   * @param tr  the throwable to be log
   */
  ...
  /**
   * AppLog an object with specific log level.
   *
  ...
  /**
   * AppLog an array with specific log level.
   *
   * @param logLevel the specific log level
   * @param array    the array to log
   * @since 1.4.0
  ...
  /**
   * AppLog a message with specific log level.
   *
   * @param logLevel the specific log level
   * @param format   the format of the message to log, null if just need to concat arguments
   * @param args     the arguments of the message to log
  ...
  /**
   * AppLog a message and a throwable with specific log level.
   *
   * @param logLevel the specific log level
   * @param msg      the message to log
   * @param tr       the throwable to be log
  ...
  /**
   * AppLog a JSON string, with level {@link LogLevel#DEBUG} by default.
   *
  ...
  /**
   * AppLog a XML string, with level {@link LogLevel#DEBUG} by default.
   *
  ...
  private void printlnInternal(int logLevel, String msg) {
    ...
    if (logConfiguration.interceptors != null) {
      ...
      for (Interceptor interceptor : logConfiguration.interceptors) {
        ...
        if (log == null) {
          // AppLog is eaten, don't print this log.
          return;
        }
